...
首先安装[TeX Live][https://tug.org/texlive/]和[TeX Studio][https://texstudio.org/]，不详细展开。
...
【选项】【设置TeX Studio】【构建】中选择XeLaTeX作为默认编译器。点击编译按钮，源文件会被转换为 PDF 文档，这需要花费一定的时间。在编译结束后，TeXworks 的 PDF 查看器会打开并预览生成的文件。PDF 文件会被自动地保存在与 TeX 文档相同的目录下。
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 点击 **Typeset** 按扭，核对生成的 PDF 文档。
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 将 "A sentence of text." 替换为以下文本：
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 在 `\subsection{Stage 1}` 下面另起一行，输入 `\label{sec1}`。→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 在 **Results** 章节输入 `Referring to section \ref{sec1} on page \pageref{sec1}`。
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 编译并检查 PDF 文档（你可能需要连续编译两次）：
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 编译并核对文档（可能需要多次编译，下文不赘述）。
...
![p5](assets/latex-for-beginners-5.png)

→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 在你的文档中添加更多的文本并尝试各种字体效果。
...
![p6](assets/latex-for-beginners-6.png)
...
![p7](assets/latex-for-beginners-7.png)

→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 尝试为你的文本调整字体大小。
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 编译并核对 PDF 文档。
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 输入代码来在你的文档中生成下面内容：
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 在你文档的前导命令中添加 `\usepackage{graphicx}`。→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 找到一张图片，放置在你的 **LaTeX course** 文件夹下。→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 在你想要添加图片的地方输入以下内容：
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 编译并核对文件。
...
→![\rightarrow](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7) 撰写代码来生成下列公式：
